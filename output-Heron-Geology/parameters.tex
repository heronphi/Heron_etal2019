...
\label{parameters:Composition_20solver_20tolerance}
...
\label{parameters:Linear_20solver_20A_20block_20tolerance}
...
\label{parameters:Linear_20solver_20S_20block_20tolerance}
...
\label{parameters:Linear_20solver_20tolerance}
...
\label{parameters:Maximum_20number_20of_20expensive_20Stokes_20solver_20steps}
...
\label{parameters:Number_20of_20cheap_20Stokes_20solver_20steps}
...
\label{parameters:Temperature_20solver_20tolerance}
...
\label{parameters:Use_20direct_20solver_20for_20Stokes_20system}
...
{\it Value:} if (x<=0e3 \&\& z>=480e3, 1.0*cm/year,if (x>=800e3 \&\& z>=480e3, -1.0*cm/year, if (x<=0e3 \&\& z<480e3 \&\& z>=375e3,  (1.*cm/year - ((0.00000952381)*(600e3-120e3-z)*cm/year)), if (x>=800e3 \&\& z<480e3 \&\& z>=375e3,  (-1.*cm/year + ((0.00000952381)*(600e3-120e3-z)*cm/year)), if (x<=0e3 \&\& z>=200e3 \&\& z<375e3,  (0 - ((0.00000342857)*(600e3-120e3-105e3-z)))*cm/year, if (x>=800e3 \&\& z>=200e3 \&\& z<375e3,  (0 + ((0.00000342857)*(600e3-120e3-105e3-z)))*cm/year, if (x>=800e3 \&\& z<200e3,  (0.6*cm/year),if (x<=0e3 \&\&  z<200e3,  (-0.6*cm/year), 0))))))));0; 22e-09
...
{\it Value:} eii, upper, lower, mantle, astheno, seed
...
{\it Value:} compositional heating
...
\label{parameters:Heating_20model/Model_20name}
...
`Boundary layers': Composition is given as two boundary layers.
...
{\it Possible values:} A comma-separated list of any of Boundary layers, ascii data, function, porosity
\item {\it Parameter name:} {\tt List of model operators}
...
{\it Possible values:} Any one of Boundary layers, ascii data, function, porosity, unspecified
\end{itemize}
...
\subsection{Parameters in section \tt Initial composition model/Boundary layers}
\label{parameters:Initial_20composition_20model/Boundary_20layers}

\begin{itemize}
\item {\it Parameter name:} {\tt Lithosphere thickness}
\phantomsection\label{parameters:Initial composition model/Boundary layers/Lithosphere thickness}
\label{parameters:Initial_20composition_20model/Boundary_20layers/Lithosphere_20thickness}


\index[prmindex]{Lithosphere thickness}
\index[prmindexfull]{Initial composition model!Boundary layers!Lithosphere thickness}
{\it Value:} 100000
...
{\it Description:} The thickness of the oceanic lithosphere.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Lower boundary layer thickness}
\phantomsection\label{parameters:Initial composition model/Boundary layers/Lower boundary layer thickness}
\label{parameters:Initial_20composition_20model/Boundary_20layers/Lower_20boundary_20layer_20thickness}


\index[prmindex]{Lower boundary layer thickness}
\index[prmindexfull]{Initial composition model!Boundary layers!Lower boundary layer thickness}
{\it Value:} 150000
...
{\it Description:} The thickness of the lower boundary layer.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Mantle morb content}
\phantomsection\label{parameters:Initial composition model/Boundary layers/Mantle morb content}
\label{parameters:Initial_20composition_20model/Boundary_20layers/Mantle_20morb_20content}


\index[prmindex]{Mantle morb content}
\index[prmindexfull]{Initial composition model!Boundary layers!Mantle morb content}
{\it Value:} 0.18
...
{\it Description:} The MORB content of the general mantle.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Upper boundary layer thickness}
\phantomsection\label{parameters:Initial composition model/Boundary layers/Upper boundary layer thickness}
\label{parameters:Initial_20composition_20model/Boundary_20layers/Upper_20boundary_20layer_20thickness}


\index[prmindex]{Upper boundary layer thickness}
\index[prmindexfull]{Initial composition model!Boundary layers!Upper boundary layer thickness}
{\it Value:} 7000
...
{\it Description:} The thickness of the upper boundary layer.
...
{\it Value:} angle\_hor=75, pi=3.14159265359, scar\_wid=10e3, angle\_vert = 0, scar\_len = 50e3, ylim1=300e3, ylim2= 500.e3, xlim1=400.e3, xlim2 = 435.4e3
...
{\it Value:} 0; if(z>=580.e3, 1, 0); if(z<580.e3 \&\& z>=570.e3, 1, 0); if(z<570.e3 \&\& z>=480.e3,1, 0); if(z<480.e3 \&\& z>-200.e3,1, 0); if(z<568.e3 \&\& z>548.e3 \&\& (y>=ylim1 \&\& y<ylim2 \&\& ((x>=(xlim1+(568e3-z)*tan(angle\_hor*(pi/180))+(ylim2-y)*(tan(angle\_vert*(pi/180)))) \&\& x<(xlim1+(scar\_wid)+(568e3-z)*tan(angle\_hor*(pi/180))+(ylim2-y)*(tan(angle\_vert*(pi/180)))))) || (y<(ylim2+scar\_wid) \&\& y>=(ylim2) \&\& x>=(xlim1+(568e3-z)*tan(angle\_hor*(pi/180))) \&\& x<(xlim1+100e3+(568e3-z)*tan(angle\_hor*(pi/180)))) || (y<(ylim1) \&\& y>=(ylim1-100e3) \&\& x>=((xlim1)+(568e3-z)*tan(angle\_hor*(pi/180))+(ylim1-y)*(tan(45*(pi/180)))) \&\& x<(xlim1+scar\_wid+(568e3-z)*tan(angle\_hor*(pi/180))+(ylim1-y)*(tan(45*(pi/180)))))),1,0);
...
`citcom reference comparison': Temperature is prescribed as an adiabatic profile with upper and lower thermal boundary layers, whose ages are given as input parameters. Adjusted to match the reference citcom model.
...
{\it Possible values:} A comma-separated list of any of S40RTS perturbation, SAVANI perturbation, adiabatic, adiabatic boundary, ascii data, citcom reference comparison, function, harmonic perturbation, inclusion shape perturbation, mandelbox, perturbed box, polar box, solidus, spherical gaussian perturbation, spherical hexagonal perturbation
\item {\it Parameter name:} {\tt List of model operators}
...
{\it Possible values:} Any one of S40RTS perturbation, SAVANI perturbation, adiabatic, adiabatic boundary, ascii data, citcom reference comparison, function, harmonic perturbation, inclusion shape perturbation, mandelbox, perturbed box, polar box, solidus, spherical gaussian perturbation, spherical hexagonal perturbation, unspecified
\end{itemize}
...
\subsection{Parameters in section \tt Initial temperature model/Citcom reference comparison}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison}

\begin{itemize}
\item {\it Parameter name:} {\tt Age bottom boundary layer}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Age bottom boundary layer}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Age_20bottom_20boundary_20layer}


\index[prmindex]{Age bottom boundary layer}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Age bottom boundary layer}
{\it Value:} 0e0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Age top boundary layer}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Age top boundary layer}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Age_20top_20boundary_20layer}


\index[prmindex]{Age top boundary layer}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Age top boundary layer}
{\it Value:} 0e0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Amplitude}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Amplitude}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Amplitude}


\index[prmindex]{Amplitude}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Amplitude}
{\it Value:} 0e0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Position}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Position}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Position}


\index[prmindex]{Position}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Position}
{\it Value:} center
...
{\it Possible values:} Any one of center
\item {\it Parameter name:} {\tt Radius}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Radius}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Radius}


\index[prmindex]{Radius}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Radius}
{\it Value:} 0e0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Subadiabaticity}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Subadiabaticity}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Subadiabaticity}


\index[prmindex]{Subadiabaticity}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Subadiabaticity}
{\it Value:} 0e0
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt Thickness bottom boundary layer}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Thickness bottom boundary layer}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Thickness_20bottom_20boundary_20layer}


\index[prmindex]{Thickness bottom boundary layer}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Thickness bottom boundary layer}
{\it Value:} 0
...
{\it Description:} Thickness of the constant bottom boundary layer.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq \text{MAX\_DOUBLE}$
\item {\it Parameter name:} {\tt dT}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/dT}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/dT}


\index[prmindex]{dT}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!dT}
{\it Value:} 0
...
{\it Description:} The temperature jump of the bottom boundary layer.
...
\subsection{Parameters in section \tt Initial temperature model/Citcom reference comparison/Function}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Function}

\begin{itemize}
\item {\it Parameter name:} {\tt Function constants}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Function/Function constants}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Function/Function_20constants}


\index[prmindex]{Function constants}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Function!Function constants}
{\it Value:} 
...
{\it Possible values:} Any string
\item {\it Parameter name:} {\tt Function expression}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Function/Function expression}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Function/Function_20expression}


\index[prmindex]{Function expression}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Function!Function expression}
{\it Value:} 0
...
{\it Possible values:} Any string
\item {\it Parameter name:} {\tt Variable names}
\phantomsection\label{parameters:Initial temperature model/Citcom reference comparison/Function/Variable names}
\label{parameters:Initial_20temperature_20model/Citcom_20reference_20comparison/Function/Variable_20names}


\index[prmindex]{Variable names}
\index[prmindexfull]{Initial temperature model!Citcom reference comparison!Function!Variable names}
{\it Value:} x,t
...
{\it Value:} h=600e3,ts1=273,ts2=681.5714,ts3=823.,ts4=1573., k1=2.5,k2=2.5,k3=3.3,k4=39.25,A=1.5e-6, qs1=0.0653571,qs2=0.035357,qs3=0.0275,qb3=0.01265823
...
{\it Value:} if( (h-z)<=20.e3, ts1 + (qs1/k1)*(h-z) - (A*(h-z)*(h-z))/(2.0*k1), if((h-z)>20.e3 \&\& (h-z)<=30.e3, ts2 + (qs2/k2)*(h-z-20.e3),if((h-z)>30.e3 \&\& (h-z)<=120.e3, ts3 + (qs3/k3)*(h-z-30.e3), ts4 + (qb3/k4)*(h-z-120e3))));
...
\label{parameters:Initial_20temperature_20model/Solidus/Lithosphere_20thickness}
...
\label{parameters:Initial_20temperature_20model/Solidus/Supersolidus}
...
\label{parameters:Initial_20temperature_20model/Solidus/Data/Solidus_20filename}
...
\label{parameters:Initial_20temperature_20model/Solidus/Perturbation/Lateral_20wave_20number_20one}
...
\label{parameters:Initial_20temperature_20model/Solidus/Perturbation/Lateral_20wave_20number_20two}
...
\label{parameters:Initial_20temperature_20model/Solidus/Perturbation/Lithosphere_20thickness_20amplitude}
...
\label{parameters:Initial_20temperature_20model/Solidus/Perturbation/Temperature_20amplitude}
...
{\it Value:} 530.e3, 530.e3,   223.e3,   345.e3,   530.e3, 530.e3, 530.e3
...
{\it Value:} 18.e-6, 18.e-6,       0.,       0.,   18.e-6, 18.e-6,  18.e-6
...
{\it Value:} 20.e6, 20.e6, 20.e6, 20.e6, 20.e6, 20.e6, 20.e6
...
{\it Value:} 3300, 3300,        2800,        2900,        3300,         3300, 3300
...
\label{parameters:Material_20model/Visco_20Plastic/End_20strain_20weakening_20intervals}
...
{\it Value:} 750, 750.,        750.,        750.,        750.,         750., 750.
...
{\it Value:} 6.52e-16, 6.52e-16, 8.57e-28, 7.13e-18, 6.52e-16, 6.52e-16, 6.52e-16
...
\label{parameters:Material_20model/Visco_20Plastic/Start_20strain_20weakening_20intervals}
...
{\it Value:} 3.5, 3.5,      4.0,      3.0,      3.5, 3.5, 3.5
...
{\it Value:} 1.333333e-6, 1.333333e-6, 1.190476e-6, 1.149425e-6, 1.333333e-6, 1.333333e-6, 1.333333e-6
...
{\it Value:} 2e-5, 2e-5,        2e-5,        2e-5,        2e-5,         2e-5, 2e-5
...
\label{parameters:Material_20model/Visco_20Plastic/Viscous_20strain_20weakening_20factors}
...
{\it Value:} if(z>=520e3, 7,if(z<520e3 \&\& z>=420e3, 4 ,3))
...
\label{parameters:Model_20settings/Enable_20additional_20Stokes_20RHS}
...
\label{parameters:Model_20settings/Fixed_20composition_20boundary_20indicators}
...
\label{parameters:Model_20settings/Fixed_20temperature_20boundary_20indicators}
...
\label{parameters:Model_20settings/Free_20surface_20boundary_20indicators}
...
\label{parameters:Model_20settings/Include_20adiabatic_20heating}
...
\label{parameters:Model_20settings/Include_20latent_20heat}
...
\label{parameters:Model_20settings/Include_20melt_20transport}
...
\label{parameters:Model_20settings/Include_20shear_20heating}
...
\label{parameters:Model_20settings/Prescribed_20traction_20boundary_20indicators}
...
\label{parameters:Model_20settings/Prescribed_20velocity_20boundary_20indicators}
...
{\it Value:} left x: function, right x:function, bottom z:function
...
\label{parameters:Model_20settings/Remove_20nullspace}
...
\label{parameters:Model_20settings/Tangential_20velocity_20boundary_20indicators}
...
\label{parameters:Model_20settings/Zero_20velocity_20boundary_20indicators}
...
{\it Value:} velocity statistics, topography, basic statistics, temperature statistics, visualization
...
{\it Description:} A comma seperated list of file formats to be used for graphical output.
...
{\it Value:} density, viscosity, strain rate
...
{\it Value:} compaction viscosity,permeability,p\_c


{\it Default:} compaction viscosity,permeability,p\_c
...
{\it Possible values:} A comma-separated list of any of compaction viscosity, fluid viscosity, permeability, fluid density, fluid density gradient, p\_c, is melt cell, darcy coefficient, darcy coefficient no cutoff
\end{itemize}
